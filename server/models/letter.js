...
const correspondenceSchema = new mongoose.Schema({
  ...
  contentOfLetter: {
    type: String,
    required: false, // or true if it is mandatory
},
  writtenDate: {
    type: Date,
    required: true,
  ...
  decisionDetails: {
    employee: { type: String, required: true }, // Employee to whom the letter is sent
    decisionDate: { type: Date, required: true }, // Date on which the letter is sent for decision
    decision: { type: String, required: true }, // Decision
    decisionDescription: { type: String, required: true }, // Decision description
